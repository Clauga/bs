...
export class BookCardComponent {
  ...
  //estos output son los eventos que se lanzan al hacer click en los botones de la tarjeta
  //por ejemplo al hacer click en el boton de compartir se lanza el evento share
